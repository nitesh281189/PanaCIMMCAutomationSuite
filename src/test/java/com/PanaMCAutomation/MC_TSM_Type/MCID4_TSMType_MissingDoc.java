...
public class MCID4_TSMType_MissingDoc extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify Table Description as Mandatory Field of Time Sensetive Material Type");
