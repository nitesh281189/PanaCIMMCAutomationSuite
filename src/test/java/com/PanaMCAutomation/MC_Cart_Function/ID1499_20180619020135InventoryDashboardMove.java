...
public class ID1499_20180619020135InventoryDashboardMove extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the functionlity of Drag and drop of row headers");
		...
		System.out.println("Running ID1499_20180619020135InventoryDashboardMove");
