...
public class ID1487_20180619020135InventoryDashboardScrap extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of View Cart scrap Button");
		...
		System.out.println("Running ID1487_20180619020135InventoryDashboardScrap");
