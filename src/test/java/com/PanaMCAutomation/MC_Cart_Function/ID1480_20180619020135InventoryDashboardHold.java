...
public class ID1480_20180619020135InventoryDashboardHold extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the behaviour of view Cart Hold button");
		...
		System.out.println("Running ID1480_20180619020135InventoryDashboardHold");
