...
public class ID_InventoryDashboardUnSealWithoutLocation extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of UnSeal/UnPackage without location");
		...
		System.out.println("Running ID_InventoryDashboardUnSealWithoutLocation");
