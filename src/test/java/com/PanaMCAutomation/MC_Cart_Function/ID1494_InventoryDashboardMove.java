...
public class ID1494_InventoryDashboardMove extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the behaviour of view Cart's Move button" );
		...
		System.out.println("Running ID1494_InventoryDashboardMove");
