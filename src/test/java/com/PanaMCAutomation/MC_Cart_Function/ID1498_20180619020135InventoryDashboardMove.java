...
public class ID1498_20180619020135InventoryDashboardMove extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionality of column selection filter");
		...
		System.out.println("Running ID1498_20180619020135InventoryDashboardMove");
