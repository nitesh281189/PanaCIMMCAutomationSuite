...
public class Precondition2 extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Part Creation with Material Control Default Receiving Location");
		...
		System.out.println("Running ID_InventoryDashboardSeal");
