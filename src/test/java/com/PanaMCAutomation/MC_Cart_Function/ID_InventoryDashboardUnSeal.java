...
public class ID_InventoryDashboardUnSeal extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the functionlity of UnPackage Option");
		...
		System.out.println("Running ID_InventoryDashboardUnSeal");
