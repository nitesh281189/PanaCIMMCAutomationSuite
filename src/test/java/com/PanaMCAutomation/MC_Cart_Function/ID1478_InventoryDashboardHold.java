...
public class ID1478_InventoryDashboardHold extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the behaviour of View Cart's Hold function under Hold PopIn");
		...
		System.out.println("Running ID1478_InventoryDashboardHold");
