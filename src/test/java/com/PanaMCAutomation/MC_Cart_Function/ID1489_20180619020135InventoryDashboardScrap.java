...
public class ID1489_20180619020135InventoryDashboardScrap extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify Scrap Button behaviour after removing the element from view Cart");
		...
		System.out.println("Running ID1489_20180619020135InventoryDashboardScrap");
