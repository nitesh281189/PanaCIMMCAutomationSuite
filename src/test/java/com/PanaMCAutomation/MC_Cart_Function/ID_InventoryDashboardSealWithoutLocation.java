...
public class ID_InventoryDashboardSealWithoutLocation extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Seal/Package without Location");
		...
		System.out.println("Running ID_InventoryDashboardSealWithoutLocation");
