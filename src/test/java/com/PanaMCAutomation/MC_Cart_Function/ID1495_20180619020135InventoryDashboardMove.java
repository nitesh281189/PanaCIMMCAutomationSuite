...
public class ID1495_20180619020135InventoryDashboardMove extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the functionality of Move Material");
		...
		System.out.println("Running ID1495_20180619020135InventoryDashboardMove");
