...
public class ID1497_20180619020135InventoryDashboardMove extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the behaviour of move button");
		...
		System.out.println("Running ID1497_20180619020135InventoryDashboardMove");
