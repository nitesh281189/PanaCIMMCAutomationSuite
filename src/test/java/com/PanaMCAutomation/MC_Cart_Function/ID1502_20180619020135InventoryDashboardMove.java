...
public class ID1502_20180619020135InventoryDashboardMove extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the functionality of Receive material" );
		...
		System.out.println("Running ID1502_20180619020135InventoryDashboardMove");
