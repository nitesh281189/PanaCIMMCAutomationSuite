...
public class ID1486_InventoryDashboardScrap extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the behaviour of view Cart Scrap button");
		...
		System.out.println("Running ID1486_InventoryDashboardScrap");
