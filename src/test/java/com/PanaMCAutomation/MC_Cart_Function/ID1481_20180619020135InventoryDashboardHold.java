...
public class ID1481_20180619020135InventoryDashboardHold extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To Verify hold button is not clickable");
		...
		System.out.println("Running ID1481_20180619020135InventoryDashboardHold");
