...
public class ID1491_20180619020135InventoryDashboardUnscrap extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of View Cart Unscrap Material");
		...
		System.out.println("Running ID1491_20180619020135InventoryDashboardUnscrap");
