...
public class ID1490_InventoryDashboardUnscrap extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the behaviour of view Cart UnScrap button");
		...
		System.out.println("Running ID1490_InventoryDashboardUnscrap");
