...
public class ID1493_20180619020135InventoryDashboardUnscrap extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify UnScrap Button behaviour after removing the element from view Cart");
		...
		System.out.println("Running ID1493_20180619020135InventoryDashboardUnscrap");
