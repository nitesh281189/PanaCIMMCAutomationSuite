...
public class MCID1761_UserConfig_UserGroup_ScreenComponents extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify all components of User Group Tab");
		...
		System.out.println("Running MCID1761: User Group Screen Components Test");
