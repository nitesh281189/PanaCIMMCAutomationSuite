...
public class MCID1511_SystemConfig_ImportData_ImportPartViaExcel2 extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check and verify Import Data Dashboard");
		...
		System.out.println("Running MCID1511: Import Data Import Part Via Excel 2 Test");
