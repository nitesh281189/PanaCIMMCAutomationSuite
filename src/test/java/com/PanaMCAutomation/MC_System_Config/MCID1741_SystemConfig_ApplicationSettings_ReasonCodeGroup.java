...
public class MCID1741_SystemConfig_ApplicationSettings_ReasonCodeGroup extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Application settings Reason Code Group.");
		...
		System.out.println("Running MCID1741: Application Settings Reason Code Group Test");
