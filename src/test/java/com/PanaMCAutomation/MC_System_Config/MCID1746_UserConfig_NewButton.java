...
public class MCID1746_UserConfig_NewButton extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the All Components of User config New Button.");
		...
		System.out.println("Running MCID1746: User Config New Button Test");
