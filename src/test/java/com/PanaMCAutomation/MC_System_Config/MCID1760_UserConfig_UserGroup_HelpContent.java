...
public class MCID1760_UserConfig_UserGroup_HelpContent extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the User Group Help Content.");
		...
		System.out.println("Running MCID1760: User Group Help Content Test");
