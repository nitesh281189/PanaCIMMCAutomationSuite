...
public class MCID1768_UserConfig_UserGroup_SelectDropdown extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify all the Items under Assigned User Tab");
		...
		System.out.println("Running MCID1768: User Group Select Dropdown Test");
