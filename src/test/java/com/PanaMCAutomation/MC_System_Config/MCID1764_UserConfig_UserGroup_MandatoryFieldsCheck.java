...
public class MCID1764_UserConfig_UserGroup_MandatoryFieldsCheck extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the User Group Mandatory Fields Check.");
		...
		System.out.println("Running MCID1764: User Group Mandatory Fields Check Test");
