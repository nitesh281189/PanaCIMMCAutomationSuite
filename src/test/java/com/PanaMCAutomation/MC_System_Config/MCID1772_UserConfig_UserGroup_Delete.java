...
public class MCID1772_UserConfig_UserGroup_Delete extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Delete functionality of Group Name under Assigned User Tab");
		...
		System.out.println("Running MCID1772: User Group Delete Test");
