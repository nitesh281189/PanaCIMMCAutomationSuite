...
public class MCID1747_UserConfig_UserProfile_Checkbox extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the User config User Profile Check Box..");
		...
		System.out.println("Running MCID1747: User Config User Profile Checkbox Test");
