...
public class MCID1745_UserConfig_ScreenComponents extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the User Config Screen All Components");
		...
		System.out.println("Running MCID1745: User Config Screen Components Test");
