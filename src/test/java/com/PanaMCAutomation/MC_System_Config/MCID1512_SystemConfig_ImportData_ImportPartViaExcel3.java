...
public class MCID1512_SystemConfig_ImportData_ImportPartViaExcel3 extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running MCID1512: Import Data Import Part Via Excel 3 Test");
