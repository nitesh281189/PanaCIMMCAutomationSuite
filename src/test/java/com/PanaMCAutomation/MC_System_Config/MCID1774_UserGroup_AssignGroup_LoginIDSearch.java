...
public class MCID1774_UserGroup_AssignGroup_LoginIDSearch extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Search Functionality of Group Name");
		...
		System.out.println("Running MCID1777: Assign Group Login ID Search Test");
