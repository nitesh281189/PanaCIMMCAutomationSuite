...
public class MCID1766_UserConfig_UserGroup_Cancel extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of cancel button of User group");
		...
		System.out.println("Running MCID1766: User Group Cancel Test");
