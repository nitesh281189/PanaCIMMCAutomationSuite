...
public class MCID1756_UserConfig_AssignGroup_Delete extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Delete functionality of Group Name.");
		...
		System.out.println("Running MCID1756: Assign Group Delete Test");
