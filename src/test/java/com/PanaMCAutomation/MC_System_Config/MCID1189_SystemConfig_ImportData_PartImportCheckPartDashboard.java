...
public class MCID1189_SystemConfig_ImportData_PartImportCheckPartDashboard extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the functionality of Import data");
		...
		System.out.println("Running MCID1189: Import Data Part Import Check Part Dashboard Test");
