...
public class MCID1762_UserConfig_UserGroup_New extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify all fields under User Group New");
		...
		System.out.println("Running MCID1762: User Group New Test");
