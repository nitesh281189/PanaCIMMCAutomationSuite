...
public class MCID1759_UserConfig_AssignGroup_LoginIDRowsFilter extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Assign Group Login ID Rows Filter.");
		...
		System.out.println("Running MCID1759: Assign Group Login ID Rows Filter Test");
