...
public class MCID1769_UserConfig_UserGroup_SelectDropdownGroupSelection extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the functionality of Group Name Selection Under Assigned User Tab");
		...
		System.out.println("Running MCID1769: User Group Select Dropdown Group Selection Test");
