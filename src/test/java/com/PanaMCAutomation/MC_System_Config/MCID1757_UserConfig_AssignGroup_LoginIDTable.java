...
public class MCID1757_UserConfig_AssignGroup_LoginIDTable extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Items of LoginID Table");
		...
		System.out.println("Running MCID1757: Assign Group Login ID Table Test");
