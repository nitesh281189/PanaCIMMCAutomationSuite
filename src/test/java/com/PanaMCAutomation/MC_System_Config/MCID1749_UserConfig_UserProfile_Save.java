...
public class MCID1749_UserConfig_UserProfile_Save extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the save button functionality of User Profile.");
		...
		System.out.println("Running MCID1749: User Config User Profile Save Test");
