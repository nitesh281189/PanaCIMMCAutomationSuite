...
public class MCID1753_UserConfig_AssignGroup_SelectDropdownGroupSelection extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the functionality of Group Name Selection Under Assign Group");
		...
		System.out.println("Running MCID1753: Assign Group Select Dropdown Group Selection Test");
