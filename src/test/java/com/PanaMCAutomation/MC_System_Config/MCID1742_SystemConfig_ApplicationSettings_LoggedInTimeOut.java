...
public class MCID1742_SystemConfig_ApplicationSettings_LoggedInTimeOut extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Application Settings Logged In Time Out.");
		...
		System.out.println("Running MCID1742: Application Settings Logged In Time Out Test");
