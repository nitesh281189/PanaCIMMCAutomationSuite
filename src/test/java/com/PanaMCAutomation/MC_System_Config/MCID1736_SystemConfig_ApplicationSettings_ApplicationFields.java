...
public class MCID1736_SystemConfig_ApplicationSettings_ApplicationFields extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check and verify Application setting Fields");
		...
		System.out.println("Running MCID1736: Application Settings Application Fields Test");
