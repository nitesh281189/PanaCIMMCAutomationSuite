...
public class MCID1758_UserConfig_AssignGroup_LoginIDSearch extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Search Functionality of LoginID");
		...
		System.out.println("Running MCID1758: Assign Group Login ID Search Test");
