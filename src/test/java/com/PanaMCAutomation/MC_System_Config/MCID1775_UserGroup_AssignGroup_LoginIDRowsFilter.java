...
public class MCID1775_UserGroup_AssignGroup_LoginIDRowsFilter extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the User Group 'Group Name' Rows Filter.");
		...
		System.out.println("Running MCID1775: Assign Group Login ID Rows Filter Test");
