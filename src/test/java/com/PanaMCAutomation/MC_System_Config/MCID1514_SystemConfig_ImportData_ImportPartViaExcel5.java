...
public class MCID1514_SystemConfig_ImportData_ImportPartViaExcel5 extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Import Data Part Import with Invalid File Type");
		...
		System.out.println("Running MCID1514: Import Data Import Part Via Excel 5 Test");
