...
public class MCID1739_SystemConfig_ApplicationSettings_RecordPerPage extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Application settings Record Per Page.");
		...
		System.out.println("Running MCID1739: Application Settings Record Per Page Test");
