...
public class MCID1748_UserConfig_UserProfile_MandatoryFieldsCheck extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the User Config User Profile Mandatory Fields Check.");
		...
		System.out.println("Running MCID1748: User Config User Profile Mandatory Fields Check Test");
