...
public class MCID1751_UserConfig_UserProfile_TabSwitching extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the all Tab Under User Config.");
		...
		System.out.println("Running MCID1751: User Config Tab Switching Test");
