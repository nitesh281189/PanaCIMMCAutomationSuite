...
public class MCID1763_UserConfig_UserGroup_SearchBox extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Search Functionality of User Group.");
		...
		System.out.println("Running MCID1763: User Group Search Box Test");
