...
public class MCID1737_SystemConfig_ApplicationSettings_UserInterfaceFields extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Application Settings User Interface Fields");
		...
		System.out.println("Running MCID1737: Application Settings User Interface Fields Test");
