...
public class MCID1750_UserConfig_UserProfile_Cancel extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Cancel button functionality of User Profile.");
		...
		System.out.println("Running MCID1750: User Config User Profile Cancel Test");
