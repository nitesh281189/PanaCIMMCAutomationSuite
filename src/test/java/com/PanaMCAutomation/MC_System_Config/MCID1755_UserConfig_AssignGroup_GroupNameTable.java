...
public class MCID1755_UserConfig_AssignGroup_GroupNameTable extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Assign Group Name under Group Name Table.");
		...
		System.out.println("Running MCID1755: Assign Group Group Name Table Test");
