...
public class MCID1744_SystemConfig_ApplicationSettings_AutoRefreshPrintQueue extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Application settings Auto Refresh Print Queue.");
		...
		System.out.println("Running MCID1744: Application Settings Auto Refresh Print Queue Test");
