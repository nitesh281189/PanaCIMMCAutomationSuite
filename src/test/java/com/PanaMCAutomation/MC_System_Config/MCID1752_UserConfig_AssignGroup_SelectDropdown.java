...
public class MCID1752_UserConfig_AssignGroup_SelectDropdown extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify all the Items under Assign group Tab");
		...
		System.out.println("Running MCID1752: Assign Group Select Dropdown Test");
