...
public class MCID1510_SystemConfig_ImportData_ImportPartViaExcel1 extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check and verify Import Data Tempalate List.");
		...
		System.out.println("Running MCID1510: Import Data Import Part Via Excel 1 Test");
