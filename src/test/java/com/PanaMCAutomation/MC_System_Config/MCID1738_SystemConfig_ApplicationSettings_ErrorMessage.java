...
public class MCID1738_SystemConfig_ApplicationSettings_ErrorMessage extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Application Settings Error Message");
		...
		System.out.println("Running MCID1738: Application Settings Error Message Test");
