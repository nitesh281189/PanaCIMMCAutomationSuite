...
public class ID1079_TC002_Inventory_Part_Part_Dashboard_Column_Selector extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1079_TC002_Inventory_Part_Part_Dashboard_Column_Selector");
