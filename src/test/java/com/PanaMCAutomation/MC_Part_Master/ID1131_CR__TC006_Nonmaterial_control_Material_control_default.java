...
public class ID1131_CR__TC006_Nonmaterial_control_Material_control_default extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1131_CR__TC006_Nonmaterial_control_Material_control_default");
