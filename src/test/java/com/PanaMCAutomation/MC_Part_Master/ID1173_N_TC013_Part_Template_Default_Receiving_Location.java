...
public class ID1173_N_TC013_Part_Template_Default_Receiving_Location extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1173_N_TC013_Part_Template_Default_Receiving_Location");
