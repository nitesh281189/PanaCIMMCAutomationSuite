...
public class ID1171_TC011_Part_Template_Material_Control_check extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1171_TC011_Part_Template_Material_Control_check");
