...
public class ID1130_TC005_Nonmaterial_control_Material_control_Toggle extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1130_TC005_Nonmaterial_control_Material_control_Toggle");
