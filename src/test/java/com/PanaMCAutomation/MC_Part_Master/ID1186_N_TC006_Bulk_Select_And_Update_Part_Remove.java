...
public class ID1186_N_TC006_Bulk_Select_And_Update_Part_Remove extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1186_N_TC006_Bulk_Select_And_Update_Part_Remove");
