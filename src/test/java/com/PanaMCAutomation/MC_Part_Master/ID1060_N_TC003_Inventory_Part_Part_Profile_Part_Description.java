...
public class ID1060_N_TC003_Inventory_Part_Part_Profile_Part_Description extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1060_N_TC003_Inventory_Part_Part_Profile_Part_Description");
