...
public class ID1133_TC008_Nonmaterial_control_checked_no_data extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1133_TC008_Nonmaterial_control_checked_no_data");
