...
public class ID1185_N_TC005_Bulk_Select_And_Update_Part_Delete extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1185_N_TC005_Bulk_Select_And_Update_Part_Delete");
