...
public class ID1081_TC004_Inventory_Part_Part_Dashboard_Part extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1081_TC004_Inventory_Part_Part_Dashboard_Part");
