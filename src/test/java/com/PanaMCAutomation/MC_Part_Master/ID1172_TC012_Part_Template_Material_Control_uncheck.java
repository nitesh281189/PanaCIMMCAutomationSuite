...
public class ID1172_TC012_Part_Template_Material_Control_uncheck extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1172_TC012_Part_Template_Material_Control_uncheck");
