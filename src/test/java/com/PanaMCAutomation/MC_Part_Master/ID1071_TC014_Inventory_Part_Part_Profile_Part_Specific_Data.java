...
public class ID1071_TC014_Inventory_Part_Part_Profile_Part_Specific_Data extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1071_TC014_Inventory_Part_Part_Profile_Part_Specific_Data");
