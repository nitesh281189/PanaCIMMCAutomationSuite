...
public class ID1179_TC019_Part_Template_Part_Master_using_Template extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1179_TC019_Part_Template_Part_Master_using_Template");
