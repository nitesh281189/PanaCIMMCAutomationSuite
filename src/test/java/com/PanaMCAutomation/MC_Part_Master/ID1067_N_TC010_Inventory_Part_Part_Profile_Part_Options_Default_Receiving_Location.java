...
public class ID1067_N_TC010_Inventory_Part_Part_Profile_Part_Options_Default_Receiving_Location extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1067_N_TC010_Inventory_Part_Part_Profile_Part_Options_Default_Receiving_Location");
