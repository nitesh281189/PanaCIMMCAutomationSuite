...
public class ID1068_TC011_Inventory_Part_Part_Profile_Part_Options_Label_Configuration extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1068_TC011_Inventory_Part_Part_Profile_Part_Options_Label_Configuration");
