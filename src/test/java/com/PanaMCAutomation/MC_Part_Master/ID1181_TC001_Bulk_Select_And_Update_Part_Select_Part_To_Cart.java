...
public class ID1181_TC001_Bulk_Select_And_Update_Part_Select_Part_To_Cart extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1181_TC001_Bulk_Select_And_Update_Part_Select_Part_To_Cart");
