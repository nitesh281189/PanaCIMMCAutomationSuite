...
public class ID1059_N_TC002_Inventory_Part_Part_Profile_Part_Number extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1059_N_TC002_Inventory_Part_Part_Profile_Part_Number");
