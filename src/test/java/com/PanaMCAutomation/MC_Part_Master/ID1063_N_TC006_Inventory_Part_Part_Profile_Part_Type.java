...
public class ID1063_N_TC006_Inventory_Part_Part_Profile_Part_Type extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1063_N_TC006_Inventory_Part_Part_Profile_Part_Type");
