...
public class ID1064_TC007_Inventory_Part_Part_Profile_Unit_of_Measure extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1064_TC007_Inventory_Part_Part_Profile_Unit_of_Measure");
