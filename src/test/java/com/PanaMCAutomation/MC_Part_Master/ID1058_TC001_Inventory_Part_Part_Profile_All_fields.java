...
public class ID1058_TC001_Inventory_Part_Part_Profile_All_fields extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1058_TC001_Inventory_Part_Part_Profile_All_fields");
