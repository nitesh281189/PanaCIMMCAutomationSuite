...
public class ID1170_TC010_Part_Template_Material_Control_default_configuration extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1170_TC010_Part_Template_Material_Control_default_configuration");
