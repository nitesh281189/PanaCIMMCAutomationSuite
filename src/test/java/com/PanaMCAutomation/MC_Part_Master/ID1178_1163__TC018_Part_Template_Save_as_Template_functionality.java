...
public class ID1178_1163__TC018_Part_Template_Save_as_Template_functionality extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1178_1163__TC018_Part_Template_Save_as_Template_functionality");
