...
public class ID1061_TC004_Inventory_Part_Part_Profile_Part_Type extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1061_TC004_Inventory_Part_Part_Profile_Part_Type");
