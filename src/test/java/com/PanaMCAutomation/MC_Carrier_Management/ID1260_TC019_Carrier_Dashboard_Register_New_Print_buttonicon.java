...
public class ID1260_TC019_Carrier_Dashboard_Register_New_Print_buttonicon extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1260_TC019_Carrier_Dashboard_Register_New_Print_buttonicon");
