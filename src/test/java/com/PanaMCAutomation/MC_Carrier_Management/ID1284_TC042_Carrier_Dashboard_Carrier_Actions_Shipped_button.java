...
public class ID1284_TC042_Carrier_Dashboard_Carrier_Actions_Shipped_button extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1284_TC042_Carrier_Dashboard_Carrier_Actions_Shipped_button");
