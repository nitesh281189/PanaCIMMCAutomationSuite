...
public class ID1245_TC004_Carrier_Dashboard_gridascending_order extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1245_TC004_Carrier_Dashboard_gridascending_order");
