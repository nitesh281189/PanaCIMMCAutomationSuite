...
public class ID1299_TC056_Carrier_Cart_icon_disable_when_no_Carrier_selected extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1299_TC056_Carrier_Cart_icon_disable_when_no_Carrier_selected");
