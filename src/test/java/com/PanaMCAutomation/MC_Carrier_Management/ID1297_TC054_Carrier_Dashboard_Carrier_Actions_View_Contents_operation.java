...
public class ID1297_TC054_Carrier_Dashboard_Carrier_Actions_View_Contents_operation extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1297_TC054_Carrier_Dashboard_Carrier_Actions_View_Contents_operation");
