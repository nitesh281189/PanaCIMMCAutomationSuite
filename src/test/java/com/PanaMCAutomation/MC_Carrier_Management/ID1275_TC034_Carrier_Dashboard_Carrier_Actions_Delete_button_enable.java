...
public class ID1275_TC034_Carrier_Dashboard_Carrier_Actions_Delete_button_enable extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1275_TC034_Carrier_Dashboard_Carrier_Actions_Delete_button_enable");
