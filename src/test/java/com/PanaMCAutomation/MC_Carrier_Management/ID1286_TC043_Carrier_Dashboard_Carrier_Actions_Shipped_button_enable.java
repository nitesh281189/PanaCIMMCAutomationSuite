...
public class ID1286_TC043_Carrier_Dashboard_Carrier_Actions_Shipped_button_enable extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1286_TC043_Carrier_Dashboard_Carrier_Actions_Shipped_button_enable");
