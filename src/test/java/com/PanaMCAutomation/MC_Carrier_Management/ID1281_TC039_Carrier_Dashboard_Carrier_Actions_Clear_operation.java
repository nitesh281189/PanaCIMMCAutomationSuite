...
public class ID1281_TC039_Carrier_Dashboard_Carrier_Actions_Clear_operation extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1281_TC039_Carrier_Dashboard_Carrier_Actions_Clear_operation");
