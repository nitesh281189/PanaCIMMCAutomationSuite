...
public class ID1264_TC023_Carrier_Dashboard_Register_New_Print_Queue_Select_Printer extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1264_TC023_Carrier_Dashboard_Register_New_Print_Queue_Select_Printer");
