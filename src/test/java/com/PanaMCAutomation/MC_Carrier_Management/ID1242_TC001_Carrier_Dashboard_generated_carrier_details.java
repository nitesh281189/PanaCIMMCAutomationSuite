...
public class ID1242_TC001_Carrier_Dashboard_generated_carrier_details extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1242_TC001_Carrier_Dashboard_generated_carrier_details");
