...
public class ID1272_TC031_Carrier_Dashboard_Register_New_Print_Queue_Completed_status extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1272_TC031_Carrier_Dashboard_Register_New_Print_Queue_Completed_status");
