...
public class ID1259_TC018_Carrier_Dashboard_Register_New_No_of_required_IDs__1234567890 extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1259_TC018_Carrier_Dashboard_Register_New_No_of_required_IDs__1234567890");
