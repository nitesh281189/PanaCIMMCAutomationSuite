...
public class ID1274_TC033_Carrier_Dashboard_Carrier_Actions_Delete_button_default_state extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1274_TC033_Carrier_Dashboard_Carrier_Actions_Delete_button_default_state");
