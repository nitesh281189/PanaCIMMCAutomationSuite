...
public class ID1290_TC047_Carrier_Dashboard_Carrier_Actions_Shipped_move_out_items extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1290_TC047_Carrier_Dashboard_Carrier_Actions_Shipped_move_out_items");
