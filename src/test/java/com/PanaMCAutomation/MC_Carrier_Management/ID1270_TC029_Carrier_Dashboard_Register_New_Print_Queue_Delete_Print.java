...
public class ID1270_TC029_Carrier_Dashboard_Register_New_Print_Queue_Delete_Print extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1270_TC029_Carrier_Dashboard_Register_New_Print_Queue_Delete_Print");
