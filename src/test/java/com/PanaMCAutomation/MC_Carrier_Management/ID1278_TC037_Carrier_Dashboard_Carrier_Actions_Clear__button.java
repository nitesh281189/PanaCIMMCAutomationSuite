...
public class ID1278_TC037_Carrier_Dashboard_Carrier_Actions_Clear__button extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1278_TC037_Carrier_Dashboard_Carrier_Actions_Clear__button");
