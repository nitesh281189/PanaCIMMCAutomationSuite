...
public class ID1279_TC037_Carrier_Dashboard_Carrier_Actions_Clear_button_default_state extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1279_TC037_Carrier_Dashboard_Carrier_Actions_Clear_button_default_state");
