...
public class ID1271_TC030_Carrier_Dashboard_Register_New_Print_Queue_RetryReprint_Print extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1271_TC030_Carrier_Dashboard_Register_New_Print_Queue_RetryReprint_Print");
