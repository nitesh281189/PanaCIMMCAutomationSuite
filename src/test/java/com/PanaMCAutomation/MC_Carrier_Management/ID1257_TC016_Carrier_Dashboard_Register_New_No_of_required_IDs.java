...
public class ID1257_TC016_Carrier_Dashboard_Register_New_No_of_required_IDs extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1257_TC016_Carrier_Dashboard_Register_New_No_of_required_IDs");
