...
public class ID1296_TC053_Carrier_Dashboard_Carrier_Actions_View_Contents_button_enable extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1296_TC053_Carrier_Dashboard_Carrier_Actions_View_Contents_button_enable");
