...
public class ID1282_TC040_Carrier_Dashboard_Carrier_Actions_Clear_ConsumableShipped extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1282_TC040_Carrier_Dashboard_Carrier_Actions_Clear_ConsumableShipped");
