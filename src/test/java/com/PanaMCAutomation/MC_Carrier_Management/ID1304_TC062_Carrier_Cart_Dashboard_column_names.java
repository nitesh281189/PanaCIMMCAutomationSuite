...
public class ID1304_TC062_Carrier_Cart_Dashboard_column_names extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1304_TC062_Carrier_Cart_Dashboard_column_names");
