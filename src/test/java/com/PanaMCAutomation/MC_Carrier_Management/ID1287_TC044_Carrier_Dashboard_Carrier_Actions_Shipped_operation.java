...
public class ID1287_TC044_Carrier_Dashboard_Carrier_Actions_Shipped_operation extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1287_TC044_Carrier_Dashboard_Carrier_Actions_Shipped_operation");
