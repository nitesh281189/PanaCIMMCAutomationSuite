...
public class ID1267_TC026_Carrier_Dashboard_Register_New_Print_Queue_selectdeselect_grid_rows extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1267_TC026_Carrier_Dashboard_Register_New_Print_Queue_selectdeselect_grid_rows");
