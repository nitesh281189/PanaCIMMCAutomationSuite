...
public class ID1280_TC038_Carrier_Dashboard_Carrier_Actions_Clear_button_enable extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1280_TC038_Carrier_Dashboard_Carrier_Actions_Clear_button_enable");
