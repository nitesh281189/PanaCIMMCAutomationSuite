...
public class ID1289_TC046_Carrier_Dashboard_Carrier_Actions_Shipped_update_operation extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1289_TC046_Carrier_Dashboard_Carrier_Actions_Shipped_update_operation");
