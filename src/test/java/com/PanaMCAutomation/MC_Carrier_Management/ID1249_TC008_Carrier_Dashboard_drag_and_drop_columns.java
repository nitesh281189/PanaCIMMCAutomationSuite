...
public class ID1249_TC008_Carrier_Dashboard_drag_and_drop_columns extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1249_TC008_Carrier_Dashboard_drag_and_drop_columns");
