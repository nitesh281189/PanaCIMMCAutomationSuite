...
public class ID0000_1256__TC015_Carrier_Dashboard_Register_New_Generate_Carrier extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID0000_1256__TC015_Carrier_Dashboard_Register_New_Generate_Carrier");
