...
public class ID1263_TC022_Carrier_Dashboard_Register_New_Print_Queue_grid extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1263_TC022_Carrier_Dashboard_Register_New_Print_Queue_grid");
