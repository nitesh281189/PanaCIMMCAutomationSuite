...
public class ID1248_TC007_Carrier_Dashboard_invalid_column_search extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1248_TC007_Carrier_Dashboard_invalid_column_search");
