...
public class ID1265_TC024_Carrier_Dashboard_Register_New_Print_Queue_Refresh_button extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1265_TC024_Carrier_Dashboard_Register_New_Print_Queue_Refresh_button");
