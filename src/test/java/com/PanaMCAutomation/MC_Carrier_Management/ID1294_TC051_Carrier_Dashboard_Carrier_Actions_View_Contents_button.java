...
public class ID1294_TC051_Carrier_Dashboard_Carrier_Actions_View_Contents_button extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1294_TC051_Carrier_Dashboard_Carrier_Actions_View_Contents_button");
