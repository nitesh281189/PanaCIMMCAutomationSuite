...
public class ID1262_TC021_Carrier_Dashboard_Register_New_Print_Queue_components extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1262_TC021_Carrier_Dashboard_Register_New_Print_Queue_components");
