...
public class ID1273_TC032_Carrier_Dashboard_Carrier_Actions_Delete_button extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1273_TC032_Carrier_Dashboard_Carrier_Actions_Delete_button");
