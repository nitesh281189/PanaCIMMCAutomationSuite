...
public class ID1256_TC015_Carrier_Dashboard_Register_New_Generate_Carrier extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1256_TC015_Carrier_Dashboard_Register_New_Generate_Carrier");
