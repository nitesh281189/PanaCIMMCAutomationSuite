...
public class ID1307_TC065_Carrier_Cart_Dashboard_column_search extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1307_TC065_Carrier_Cart_Dashboard_column_search");
