...
public class ID1269_TC028_Carrier_Dashboard_Register_New_Print_Queue_Pause_Print extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1269_TC028_Carrier_Dashboard_Register_New_Print_Queue_Pause_Print");
