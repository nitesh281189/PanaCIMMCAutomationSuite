...
public class ID1276_1273__TC035_Carrier_Dashboard_Carrier_Actions_Delete_operation extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1276_1273__TC035_Carrier_Dashboard_Carrier_Actions_Delete_operation");
