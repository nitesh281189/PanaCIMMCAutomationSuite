...
public class ID1243_TC002_Carrier_Dashboard_Column_Selection_check extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1243_TC002_Carrier_Dashboard_Column_Selection_check");
