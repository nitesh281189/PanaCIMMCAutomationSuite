...
public class ID1309_Skip__TC067_Carrier_Cart_Dashboard_drag_and_drop_columns extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1309_Skip__TC067_Carrier_Cart_Dashboard_drag_and_drop_columns");
