...
public class ID1266_TC025_Carrier_Dashboard_Register_New_Print_Queue_Clear_Completed_button extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1266_TC025_Carrier_Dashboard_Register_New_Print_Queue_Clear_Completed_button");
