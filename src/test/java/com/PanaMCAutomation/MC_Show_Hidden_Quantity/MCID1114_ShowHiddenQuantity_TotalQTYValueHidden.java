...
public class MCID1114_ShowHiddenQuantity_TotalQTYValueHidden extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To Verify total Quantity Field for 'Show Qty' Tab");
		...
		System.out.println("Running MCID1114: Total QTY Value Hidden Test");
