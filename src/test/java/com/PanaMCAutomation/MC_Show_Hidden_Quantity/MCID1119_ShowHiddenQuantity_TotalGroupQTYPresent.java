...
public class MCID1119_ShowHiddenQuantity_TotalGroupQTYPresent extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To Verify total Group Quantity Fields for 'Show and Hide Qty' tab");
		...
		System.out.println("Running MCID1119: Total Group QTY Present Test");
