...
public class MCID1120_ShowHiddenQuantity_TotalGroupQTYValue extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To Verify total Group Quantity Field Value for 'Show Qty' Tab");
		...
		System.out.println("Running MCID1120: Total Group QTY Value Test");
