...
public class MCID1124_ShowHiddenQuantity_TotalQTYFilter extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To Verify total Quantity Filter");
		...
		System.out.println("Running MCID1124: Total QTY Filter Test");
