...
public class MCID1122_ShowHiddenQuantity_TotalQTYPresent extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To Verify total Quantity Field & Values both");
		...
		System.out.println("Running MCID1122: Total QTY Present Test");
