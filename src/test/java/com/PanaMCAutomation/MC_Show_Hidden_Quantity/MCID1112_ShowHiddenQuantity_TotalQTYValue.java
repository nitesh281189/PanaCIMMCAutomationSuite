...
public class MCID1112_ShowHiddenQuantity_TotalQTYValue extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To Verify total Quantity Field Value");
		...
		System.out.println("Running MCID1112: Total QTY Value Test");
