...
public class MCID1121_ShowHiddenQuantity_TotalGroupQTYValueHidden extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To Verify total Group Quantity Field for 'Show Qty' Tab");
		...
		System.out.println("Running MCID1121: Total Group QTY Value Hidden Test");
