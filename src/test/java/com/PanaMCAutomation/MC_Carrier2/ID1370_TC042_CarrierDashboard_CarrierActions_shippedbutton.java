...
public class ID1370_TC042_CarrierDashboard_CarrierActions_shippedbutton extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1370_TC042_CarrierDashboard_CarrierActions_shippedbutton");
