...
public class ID1331_TC089_CarrierDashboard_carrierdetailsscreen_box extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1331_TC089_CarrierDashboard_carrierdetailsscreen_box");
