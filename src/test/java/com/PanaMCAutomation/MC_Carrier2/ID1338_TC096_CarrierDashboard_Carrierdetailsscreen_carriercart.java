...
public class ID1338_TC096_CarrierDashboard_Carrierdetailsscreen_carriercart extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1338_TC096_CarrierDashboard_Carrierdetailsscreen_carriercart");
