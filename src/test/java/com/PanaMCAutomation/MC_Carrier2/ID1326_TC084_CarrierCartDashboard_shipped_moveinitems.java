...
public class ID1326_TC084_CarrierCartDashboard_shipped_moveinitems extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1326_TC084_CarrierCartDashboard_shipped_moveinitems");
