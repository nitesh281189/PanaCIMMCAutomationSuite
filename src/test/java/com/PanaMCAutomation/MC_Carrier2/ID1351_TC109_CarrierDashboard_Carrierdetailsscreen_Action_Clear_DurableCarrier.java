...
public class ID1351_TC109_CarrierDashboard_Carrierdetailsscreen_Action_Clear_DurableCarrier extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1351_TC109_CarrierDashboard_Carrierdetailsscreen_Action_Clear_DurableCarrier");
