...
public class ID1344_TC102_CarrierDashboard_Carrierdetailsscreen_ViewHierarchy extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1344_TC102_CarrierDashboard_Carrierdetailsscreen_ViewHierarchy");
