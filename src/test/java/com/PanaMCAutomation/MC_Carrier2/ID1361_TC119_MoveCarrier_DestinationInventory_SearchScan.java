...
public class ID1361_TC119_MoveCarrier_DestinationInventory_SearchScan extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1361_TC119_MoveCarrier_DestinationInventory_SearchScan");
