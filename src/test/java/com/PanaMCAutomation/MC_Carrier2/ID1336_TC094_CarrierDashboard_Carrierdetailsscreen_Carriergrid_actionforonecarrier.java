...
public class ID1336_TC094_CarrierDashboard_Carrierdetailsscreen_Carriergrid_actionforonecarrier extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1336_TC094_CarrierDashboard_Carrierdetailsscreen_Carriergrid_actionforonecarrier");
