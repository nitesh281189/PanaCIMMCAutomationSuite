...
public class ID1355_TC113_CarrierDashboard_Carrierdetailsscreen_Action_Delete extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1355_TC113_CarrierDashboard_Carrierdetailsscreen_Action_Delete");
