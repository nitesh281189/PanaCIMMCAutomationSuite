...
public class ID1343_TC101_CarrierDashboard_Carrierdetailsscreen_ViewHierarchy_defaultpage extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1343_TC101_CarrierDashboard_Carrierdetailsscreen_ViewHierarchy_defaultpage");
