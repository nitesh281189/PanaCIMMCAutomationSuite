...
public class ID1348_TC106_CarrierDashboard_Carrierdetailsscreen_Childcarrierdetails extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1348_TC106_CarrierDashboard_Carrierdetailsscreen_Childcarrierdetails");
