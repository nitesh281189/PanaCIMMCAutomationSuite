...
public class ID1332_TC090_CarrierDashboard_carrierdetailsscreen_pallet extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1332_TC090_CarrierDashboard_carrierdetailsscreen_pallet");
