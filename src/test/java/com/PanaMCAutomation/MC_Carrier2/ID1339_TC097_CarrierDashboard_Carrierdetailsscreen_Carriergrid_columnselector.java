...
public class ID1339_TC097_CarrierDashboard_Carrierdetailsscreen_Carriergrid_columnselector extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1339_TC097_CarrierDashboard_Carrierdetailsscreen_Carriergrid_columnselector");
