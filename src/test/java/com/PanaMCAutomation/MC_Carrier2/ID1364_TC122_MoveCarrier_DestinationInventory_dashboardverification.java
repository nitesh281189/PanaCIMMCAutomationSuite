...
public class ID1364_TC122_MoveCarrier_DestinationInventory_dashboardverification extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1364_TC122_MoveCarrier_DestinationInventory_dashboardverification");
