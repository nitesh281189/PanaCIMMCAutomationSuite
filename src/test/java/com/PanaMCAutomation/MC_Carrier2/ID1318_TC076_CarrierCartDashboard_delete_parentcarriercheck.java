...
public class ID1318_TC076_CarrierCartDashboard_delete_parentcarriercheck extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1318_TC076_CarrierCart Dashboard_delete_parentcarriercheck");
