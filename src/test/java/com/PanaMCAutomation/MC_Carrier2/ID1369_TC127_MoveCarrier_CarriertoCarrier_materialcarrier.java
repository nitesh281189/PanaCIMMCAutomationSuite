...
public class ID1369_TC127_MoveCarrier_CarriertoCarrier_materialcarrier extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1369_TC127_MoveCarrier_CarriertoCarrier_materialcarrier");
