...
public class ID1350_TC108_CarrierDashboard_Carrierdetailsscreen_Action_Clear extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1350_TC108_CarrierDashboard_Carrierdetailsscreen_Action_Clear");
