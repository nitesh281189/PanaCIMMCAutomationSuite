...
public class ID1357_TC115_CarrierDashboard_Carrierdetailsscreen_Action_Shipped extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1357_TC115_CarrierDashboard_Carrierdetailsscreen_Action_Shipped");
