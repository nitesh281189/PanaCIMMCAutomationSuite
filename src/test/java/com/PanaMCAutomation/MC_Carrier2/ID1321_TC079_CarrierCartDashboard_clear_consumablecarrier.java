...
public class ID1321_TC079_CarrierCartDashboard_clear_consumablecarrier extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1321_TC079_CarrierCart Dashboard_clear_consumablecarrier");
