...
public class ID1330_TC088_CarrierDashboard_carrierdetailsscreen extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1330_TC088_CarrierDashboard_carrierdetailsscreen");
