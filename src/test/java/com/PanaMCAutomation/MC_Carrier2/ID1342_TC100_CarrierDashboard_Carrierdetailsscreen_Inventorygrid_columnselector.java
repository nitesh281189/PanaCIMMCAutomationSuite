...
public class ID1342_TC100_CarrierDashboard_Carrierdetailsscreen_Inventorygrid_columnselector extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1342_TC100_CarrierDashboard_Carrierdetailsscreen_Inventorygrid_columnselector");
