...
public class ID1334_TC092_CarrierDashboard_Carrierdetailsscreen_Carrierdetailscomponents extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1334_TC092_CarrierDashboard_Carrierdetailsscreen_Carrierdetailscomponents");
