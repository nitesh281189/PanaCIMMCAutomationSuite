...
public class ID1346_TC104_CarrierDashboard_Carrierdetailsscreen_ViewHierarchy_carriergrid extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1346_TC104_CarrierDashboard_Carrierdetailsscreen_ViewHierarchy_carriergrid");
