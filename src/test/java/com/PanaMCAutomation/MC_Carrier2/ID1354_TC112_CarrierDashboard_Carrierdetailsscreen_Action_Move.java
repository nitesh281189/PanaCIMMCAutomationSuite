...
public class ID1354_TC112_CarrierDashboard_Carrierdetailsscreen_Action_Move extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1354_TC112_CarrierDashboard_Carrierdetailsscreen_Action_Move");
