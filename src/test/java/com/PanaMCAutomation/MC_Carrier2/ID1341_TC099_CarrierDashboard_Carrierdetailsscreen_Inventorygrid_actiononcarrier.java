...
public class ID1341_TC099_CarrierDashboard_Carrierdetailsscreen_Inventorygrid_actiononcarrier extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1341_TC099_CarrierDashboard_Carrierdetailsscreen_Inventorygrid_actiononcarrier");
