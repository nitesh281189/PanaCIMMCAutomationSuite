...
public class ID1353_TC111_CarrierDashboard_Carrierdetailsscreen_Action_Clearwarningmessage extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1353_TC111_CarrierDashboard_Carrierdetailsscreen_Action_Clearwarningmessage");
