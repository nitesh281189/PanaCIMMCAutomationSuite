...
public class ID1316_TC074_CarrierCartDashboard_move_carriertocarrier extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1316_TC074_CarrierCartDashboard_move_carriertocarrier");
