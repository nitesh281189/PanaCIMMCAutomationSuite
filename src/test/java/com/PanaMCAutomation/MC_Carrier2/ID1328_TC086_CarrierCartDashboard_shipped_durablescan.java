...
public class ID1328_TC086_CarrierCartDashboard_shipped_durablescan extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1328_TC086_CarrierCartDashboard_shipped_durablescan");
