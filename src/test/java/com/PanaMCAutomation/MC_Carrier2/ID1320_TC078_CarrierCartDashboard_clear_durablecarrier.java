...
public class ID1320_TC078_CarrierCartDashboard_clear_durablecarrier extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1320_TC078_CarrierCart Dashboard_clear_durablecarrier");
