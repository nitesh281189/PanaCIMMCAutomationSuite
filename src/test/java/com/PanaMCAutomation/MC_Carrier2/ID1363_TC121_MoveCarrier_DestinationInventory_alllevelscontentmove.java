...
public class ID1363_TC121_MoveCarrier_DestinationInventory_alllevelscontentmove extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1363_TC121_MoveCarrier_DestinationInventory_alllevelscontentmove");
