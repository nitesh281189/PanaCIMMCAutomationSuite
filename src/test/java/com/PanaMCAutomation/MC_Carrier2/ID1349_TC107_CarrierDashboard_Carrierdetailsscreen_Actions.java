...
public class ID1349_TC107_CarrierDashboard_Carrierdetailsscreen_Actions extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1349_TC107_CarrierDashboard_Carrierdetailsscreen_Actions");
