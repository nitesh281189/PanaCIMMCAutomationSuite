...
public class ID1333_TC091_CarrierDashboard_Carrierdetailsscreen_Carrierdetails extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1333_TC091_CarrierDashboard_Carrierdetailsscreen_Carrierdetails");
