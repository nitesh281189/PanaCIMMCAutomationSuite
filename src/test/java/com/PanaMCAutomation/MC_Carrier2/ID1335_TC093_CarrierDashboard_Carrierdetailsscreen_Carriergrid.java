...
public class ID1335_TC093_CarrierDashboard_Carrierdetailsscreen_Carriergrid extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1335_TC093_CarrierDashboard_Carrierdetailsscreen_Carriergrid");
