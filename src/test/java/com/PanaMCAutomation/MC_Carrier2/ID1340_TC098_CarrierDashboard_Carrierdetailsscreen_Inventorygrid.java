...
public class ID1340_TC098_CarrierDashboard_Carrierdetailsscreen_Inventorygrid extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1340_TC098_CarrierDashboard_Carrierdetailsscreen_Inventorygrid");
