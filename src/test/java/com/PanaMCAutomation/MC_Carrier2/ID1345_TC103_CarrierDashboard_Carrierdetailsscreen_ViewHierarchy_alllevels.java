...
public class ID1345_TC103_CarrierDashboard_Carrierdetailsscreen_ViewHierarchy_alllevels extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1345_TC103_CarrierDashboard_Carrierdetailsscreen_ViewHierarchy_alllevels");
