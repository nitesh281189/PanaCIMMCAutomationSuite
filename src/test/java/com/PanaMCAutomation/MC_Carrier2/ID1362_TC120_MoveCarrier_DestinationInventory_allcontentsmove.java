...
public class ID1362_TC120_MoveCarrier_DestinationInventory_allcontentsmove extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1362_TC120_MoveCarrier_DestinationInventory_allcontentsmove");
