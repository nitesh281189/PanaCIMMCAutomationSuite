...
public class ID1366_TC124_MoveCarrier_CarriertoCarrier_SearchScan extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1366_TC124_MoveCarrier_CarriertoCarrier_SearchScan");
