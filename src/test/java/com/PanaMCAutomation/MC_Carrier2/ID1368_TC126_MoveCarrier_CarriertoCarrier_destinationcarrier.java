...
public class ID1368_TC126_MoveCarrier_CarriertoCarrier_destinationcarrier extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running ID1368_TC126_MoveCarrier_CarriertoCarrier_destinationcarrier");
