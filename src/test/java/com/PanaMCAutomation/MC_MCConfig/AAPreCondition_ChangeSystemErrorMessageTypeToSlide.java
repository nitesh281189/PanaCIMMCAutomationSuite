...
public class AAPreCondition_ChangeSystemErrorMessageTypeToSlide extends BaseTest{
	@Test(dataProvider="getData")
	public void testB(Hashtable<String,String> data) throws Exception{
		test.log(Status.INFO, "To verify functionlity of Change System Error Message Type To Slide");
	...
	throw new SkipException("Runmode is set to No");
	    ...
	    System.out.println("Running PreCondition: Change System Error Message Type To Slide");
