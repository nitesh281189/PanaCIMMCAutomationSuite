...
public class SeedConfigurationCustomType extends BaseTest{
	@Test(dataProvider="getData")
	public void testB(Hashtable<String,String> data) throws Exception{
		test.log(Status.INFO, "To Verify the functionality of Creation of seed configuration Custom Type");
