...
public class SeedConfigurationMaxCounterNo  extends BaseTest{
	@Test(dataProvider="getData")
	public void testB(Hashtable<String,String> data) throws Exception{
		test.log(Status.INFO, "To Verify the functionality of Use counter check box with counter field");
