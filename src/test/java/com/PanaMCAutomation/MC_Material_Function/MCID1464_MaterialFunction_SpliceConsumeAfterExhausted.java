...
public class MCID1464_MaterialFunction_SpliceConsumeAfterExhausted extends BaseTest {
	...
	public void testB(Hashtable<String, String> data) throws Exception {
		...
		System.out.println("Running MCID1464: Splice Consume After Exhausted Test");
