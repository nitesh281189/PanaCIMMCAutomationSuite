...
public class MCID1519_MaterialFunction_ReceivePrintQueue extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Receive Print Queue");
		...
		System.out.println("Running MCID1519: Receive Print Queue Test");
