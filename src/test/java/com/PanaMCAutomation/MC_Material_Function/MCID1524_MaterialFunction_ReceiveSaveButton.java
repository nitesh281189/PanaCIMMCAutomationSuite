...
public class MCID1524_MaterialFunction_ReceiveSaveButton extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Save Button");
		...
		System.out.println("Running MCID1524: Receive Save Button Test");
