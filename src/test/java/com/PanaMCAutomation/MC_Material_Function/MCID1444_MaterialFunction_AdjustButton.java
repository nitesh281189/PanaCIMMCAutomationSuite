...
public class MCID1444_MaterialFunction_AdjustButton extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Adjust Button");
		...
		System.out.println("Running MCID1444: Adjust Button Test");
