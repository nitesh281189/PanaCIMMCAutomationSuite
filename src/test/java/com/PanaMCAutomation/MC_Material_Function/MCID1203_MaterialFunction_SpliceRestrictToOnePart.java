...
public class MCID1203_MaterialFunction_SpliceRestrictToOnePart extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Splice Restric To One Part");
		...
		System.out.println("Running MCID1203: Splice Restric To One Part Test");
