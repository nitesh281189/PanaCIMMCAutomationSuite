...
public class MCID1199_MaterialFunction_SpliceHoldScarpMaterial extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Splice Hold Scarp Material");
		...
		System.out.println("Running MCID1199: Splice Hold Scarp Material Test");
