...
public class MCID1521_MaterialFunction_ReceivePauseAllPrinting extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Pause All Printing");
		...
		System.out.println("Running MCID1521: Receive Pause All Printing Test");
