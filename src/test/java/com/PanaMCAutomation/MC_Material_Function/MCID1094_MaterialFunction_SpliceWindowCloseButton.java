...
public class MCID1094_MaterialFunction_SpliceWindowCloseButton extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check functionality of Splice window close button");
		...
		System.out.println("Running Splice Window Close Button Test");
