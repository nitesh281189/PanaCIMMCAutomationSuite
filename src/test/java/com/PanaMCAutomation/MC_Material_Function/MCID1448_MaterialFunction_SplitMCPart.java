...
public class MCID1448_MaterialFunction_SplitMCPart extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check Functionality of Split MC part");
		...
		System.out.println("Running MCID1448: Split MC Part Test");
