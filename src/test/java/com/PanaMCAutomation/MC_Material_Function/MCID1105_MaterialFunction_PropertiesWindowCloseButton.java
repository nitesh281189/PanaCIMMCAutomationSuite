...
public class MCID1105_MaterialFunction_PropertiesWindowCloseButton extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check close button of properties window");
		...
		System.out.println("Running Properties Window Close Button Test");
