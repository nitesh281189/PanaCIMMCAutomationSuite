...
public class MCID1517_MaterialFunction_ReceiveWindow extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Receive Window");
		...
		System.out.println("Running MCID1517: Receive Window Test");
