...
public class MCID1465_MaterialFunction_SpliceConsumeToZero extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Splice Consume To Zero");
		...
		System.out.println("Running MCID1465: Splice Consume To Zero Test");
