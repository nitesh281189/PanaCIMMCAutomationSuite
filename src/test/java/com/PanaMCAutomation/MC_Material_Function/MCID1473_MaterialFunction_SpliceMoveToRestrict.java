...
public class MCID1473_MaterialFunction_SpliceMoveToRestrict extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Splice Move To Restrict");
		...
		System.out.println("Running MCID1473: Splice Move To Restrict Test");
