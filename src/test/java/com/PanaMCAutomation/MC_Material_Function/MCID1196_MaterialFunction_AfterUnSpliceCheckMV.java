...
public class MCID1196_MaterialFunction_AfterUnSpliceCheckMV extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check after Unsplice material verification");
		...
		System.out.println("Running MCID1196: After UnSplice Check MV Test");
