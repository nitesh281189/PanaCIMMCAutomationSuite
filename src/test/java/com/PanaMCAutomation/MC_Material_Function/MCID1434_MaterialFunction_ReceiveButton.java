...
public class MCID1434_MaterialFunction_ReceiveButton extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Receive Button");
		...
		System.out.println("Running MCID1434: Receive Button Test");
