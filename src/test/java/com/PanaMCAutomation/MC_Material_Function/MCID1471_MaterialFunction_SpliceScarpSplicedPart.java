...
public class MCID1471_MaterialFunction_SpliceScarpSplicedPart extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check Scarp Spliced Part functionality");
		...
		System.out.println("Running MCID1469: Splice Scarp Spliced Part Test");
