...
public class MCID1093_MaterialFunction_SpliceWindowCloseIcon extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check Splice window close icon");
		...
		System.out.println("Running Splice Window Close Icon Test");
