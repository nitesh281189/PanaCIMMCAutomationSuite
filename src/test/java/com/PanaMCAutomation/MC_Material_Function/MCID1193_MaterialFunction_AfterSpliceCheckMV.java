...
public class MCID1193_MaterialFunction_AfterSpliceCheckMV extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check after splice material verification");
		...
		System.out.println("Running After Splice Check MV Test");
