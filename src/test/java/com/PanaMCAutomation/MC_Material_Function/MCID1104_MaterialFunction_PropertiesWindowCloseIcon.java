...
public class MCID1104_MaterialFunction_PropertiesWindowCloseIcon extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check close icon of properties window");
		...
		System.out.println("Running Properties Window Close Icon Test");
