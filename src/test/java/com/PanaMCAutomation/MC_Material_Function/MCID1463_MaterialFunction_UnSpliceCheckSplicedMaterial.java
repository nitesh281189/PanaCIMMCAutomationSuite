...
public class MCID1463_MaterialFunction_UnSpliceCheckSplicedMaterial extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To Check UnSplice Spliced Material Functionality");
		...
		System.out.println("Running MCID1463: UnSplice Check Spliced Material Test");
