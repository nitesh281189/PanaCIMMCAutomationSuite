...
public class PreCondition_ChangeSystemErrorMessageTypeToPopup extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Change System Error Message Type To Popup");
		...
		System.out.println("Running PreCondition: Change System Error Message Type To Popup");
