...
public class MCID1192_MaterialFunction_SpliceActionDifferentPart extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of splice action of different part");
		...
		System.out.println("Running Splice Action Different Part Test");
