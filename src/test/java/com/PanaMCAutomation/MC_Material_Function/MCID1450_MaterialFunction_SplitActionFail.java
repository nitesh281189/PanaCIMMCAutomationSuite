...
public class MCID1450_MaterialFunction_SplitActionFail extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Split Action Fail");
		...
		System.out.println("Running MCID1450: Split Action Fail Test");
