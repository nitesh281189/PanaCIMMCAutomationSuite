...
public class MCID1451_MaterialFunction_SpliceNonMCPart extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check Functionality of Splice Non MC part");
		...
		System.out.println("Running MCID1451: Splice Non MC Part Test");
