...
public class MCID1460_MaterialFunction_UnSplicePopup extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of UnSplice PopUp");
		...
		System.out.println("Running MCID1460: UnSplice Popup Test");
