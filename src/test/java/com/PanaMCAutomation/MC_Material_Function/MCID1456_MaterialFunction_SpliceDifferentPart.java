...
public class MCID1456_MaterialFunction_SpliceDifferentPart extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of splice Different Part");
		...
		System.out.println("Running MCID1456: Splice Different Part Test");
