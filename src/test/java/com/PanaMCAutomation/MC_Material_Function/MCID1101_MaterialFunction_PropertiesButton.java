...
public class MCID1101_MaterialFunction_PropertiesButton extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verification of properties button");
		...
		System.out.println("Running Properties Button Test");
