...
public class MCID1102_MaterialFunction_PropertiesEnableDisable extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify enabled disabled properties");
		...
		System.out.println("Running Properties Enable Disable Test");
