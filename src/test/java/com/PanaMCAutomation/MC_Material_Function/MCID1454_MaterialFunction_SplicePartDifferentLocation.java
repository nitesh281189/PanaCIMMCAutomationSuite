...
public class MCID1454_MaterialFunction_SplicePartDifferentLocation extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Splice Part Different Location");
		...
		System.out.println("Running MCID1454: Splice Part Different Location Test");
