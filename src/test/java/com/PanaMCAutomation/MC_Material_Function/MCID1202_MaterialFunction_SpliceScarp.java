...
public class MCID1202_MaterialFunction_SpliceScarp extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check Splice Scarp Functionality");
		...
		System.out.println("Running MCID1202: Splice Scarp Test");
