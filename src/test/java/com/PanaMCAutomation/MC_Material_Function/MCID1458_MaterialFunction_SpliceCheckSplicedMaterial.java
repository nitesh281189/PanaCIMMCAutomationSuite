...
public class MCID1458_MaterialFunction_SpliceCheckSplicedMaterial extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Splice Check Spliced Material");
		...
		System.out.println("Running MCID1458: Splice Check Spliced Material Test");
