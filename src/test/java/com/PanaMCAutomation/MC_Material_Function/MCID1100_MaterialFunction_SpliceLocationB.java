...
public class MCID1100_MaterialFunction_SpliceLocationB extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check splice location B");
		...
		System.out.println("Running MCID1100: Splice Location B Test");
