...
public class MCID1108_MaterialFunction_PropertiesRefreshButton extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check refresh button of properties window");
		...
		System.out.println("Running Properties Refresh Button Test");
