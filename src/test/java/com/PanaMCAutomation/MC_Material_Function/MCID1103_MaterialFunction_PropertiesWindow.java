...
public class MCID1103_MaterialFunction_PropertiesWindow extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check properties window");
		...
		System.out.println("Running Properties Window Test");
