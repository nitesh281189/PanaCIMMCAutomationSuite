...
public class MCID1467_MaterialFunction_SpliceNewSplice extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of splice New Splice");
		...
		System.out.println("Running MCID1467: Splice New Splice Test");
