...
public class MCID1097_MaterialFunction_MaterialConsumption extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To Create Material consumption test");
		...
		System.out.println("Running Material Consumption Test");
