...
public class MCID1522_MaterialFunction_ReceiveDeleteAllPrinting extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Delete All Printing ");
		...
		System.out.println("Running MCID1522: Receive Delete All Printing Test");
