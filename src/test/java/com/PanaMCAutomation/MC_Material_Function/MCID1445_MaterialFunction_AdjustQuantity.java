...
public class MCID1445_MaterialFunction_AdjustQuantity extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Adjust Quantity");
		...
		System.out.println("Running MCID1445: Adjust Quantity Test");
