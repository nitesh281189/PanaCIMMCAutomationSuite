...
public class MCID1115_MaterialFunction_AutoZeroButton extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of auto zero button");
		...
		System.out.println("Running Auto Zero Button Test");
