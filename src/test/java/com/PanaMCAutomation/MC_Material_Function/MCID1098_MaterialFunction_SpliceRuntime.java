...
public class MCID1098_MaterialFunction_SpliceRuntime extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To Create test for splicing at runtime");
		...
		System.out.println("Running Splice Runtime Test");
