...
public class MCID1470_MaterialFunction_SpliceHoldSplicedPart extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check Hold Spliced Part functionality");
		...
		System.out.println("Running MCID1469: Splice Hold Spliced Part Test");
