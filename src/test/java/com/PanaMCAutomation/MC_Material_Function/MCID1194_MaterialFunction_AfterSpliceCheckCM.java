...
public class MCID1194_MaterialFunction_AfterSpliceCheckCM extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check after splice Consume Material");
		...
		System.out.println("Running MCID1194: After Splice Check Consume Material Test");
