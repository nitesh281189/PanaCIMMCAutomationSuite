...
public class MCID1466_MaterialFunction_SpliceAutoZero extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Splice Auto Zero");
		...
		System.out.println("Running MCID1466: Splice Auto Zero Test");
