...
public class MCID1474_MaterialFunction_SpliceScarpToRestrict extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Splice Scarp To Restrict");
		...
		System.out.println("Running MCID1474: Splice Scarp To Restrict Test");
