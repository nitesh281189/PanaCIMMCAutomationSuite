...
public class MCID1198_MaterialFunction_ConsumeAdjustAutoZero extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To Check Consume Adjust Auto Zero functionality");
		...
		System.out.println("Running MCID1198: Consume Adjust Auto Zero Test");
