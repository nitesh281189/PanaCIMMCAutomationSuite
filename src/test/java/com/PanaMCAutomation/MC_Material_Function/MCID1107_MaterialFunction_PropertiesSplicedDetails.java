...
public class MCID1107_MaterialFunction_PropertiesSplicedDetails extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify Spliced Material element on properties window");
		...
		System.out.println("Running Properties Spliced Details Test");
