...
public class MCID1452_MaterialFunction_SpliceMCPart extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check Functionality of Splice MC part");
		...
		System.out.println("Running MCID1452: Splice MC Part Test");
