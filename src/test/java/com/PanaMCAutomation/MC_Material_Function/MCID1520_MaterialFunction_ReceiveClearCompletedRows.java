...
public class MCID1520_MaterialFunction_ReceiveClearCompletedRows extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check Receive Clear Complated Rows Functionality");
		...
		System.out.println("Running MCID1520: Receive Clear Completed Rows Test");
