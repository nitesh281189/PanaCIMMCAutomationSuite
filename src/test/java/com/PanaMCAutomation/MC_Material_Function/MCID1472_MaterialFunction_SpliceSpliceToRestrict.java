...
public class MCID1472_MaterialFunction_SpliceSpliceToRestrict extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Splice To Restrict");
		...
		System.out.println("Running MCID1472: Splice Splice To Restrict Test");
