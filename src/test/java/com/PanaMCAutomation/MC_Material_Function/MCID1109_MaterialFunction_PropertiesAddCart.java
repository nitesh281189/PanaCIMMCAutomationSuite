...
public class MCID1109_MaterialFunction_PropertiesAddCart extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify Add Cart functionlity");
		...
		System.out.println("Running Properties Add Cart Test");
