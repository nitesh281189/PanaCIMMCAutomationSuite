...
public class MCID1201_MaterialFunction_SpliceHold extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To check Splice Hold Functionality");
		...
		System.out.println("Running MCID1201: Splice Hold Test");
