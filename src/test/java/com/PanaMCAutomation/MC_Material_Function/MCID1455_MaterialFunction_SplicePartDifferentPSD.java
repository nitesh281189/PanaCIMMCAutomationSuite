...
public class MCID1455_MaterialFunction_SplicePartDifferentPSD extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Splice Part Different Part specific data");
		...
		System.out.println("Running MCID1455: Splice Part Different PSD Test");
