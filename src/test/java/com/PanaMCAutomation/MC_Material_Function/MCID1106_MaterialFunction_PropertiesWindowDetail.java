...
public class MCID1106_MaterialFunction_PropertiesWindowDetail extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify details of properties window");
		...
		System.out.println("Running Properties Window Detail Test");
