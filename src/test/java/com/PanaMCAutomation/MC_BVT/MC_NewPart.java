...
public class MC_NewPart extends BaseTest {
	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the functionlity of Part creation.");
		...
		System.out.println("Running New Part Positive Method");
