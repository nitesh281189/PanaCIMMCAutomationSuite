package com.PanaMCAutomation.MC_BVT;
		...
		public class MC_PartTemplate extends BaseTest {

			@Test(dataProvider = "getData")
			public void testB(Hashtable<String, String> data) throws Exception {
				test.log(Status.INFO, "To verify functionlity of Part Template Creation.");
				...
				System.out.println("Running MC_PartTemplate ");
