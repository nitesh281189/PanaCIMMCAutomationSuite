...
public class MC_NewPartWithTemplate extends BaseTest {
	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the functionlity of Part creation using Part Template.");
		...
		System.out.println("Running New Part with Template Positive Method");
