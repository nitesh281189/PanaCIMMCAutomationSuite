...
public class MC_SpliceMaterial extends BaseTest {
		
		
		@Test(dataProvider = "getData")
		public void testB(Hashtable<String, String> data) throws Exception {
			test.log(Status.INFO, "To verify functionlity of splice Material.");
			...
			System.out.println("Running Splice Material");
