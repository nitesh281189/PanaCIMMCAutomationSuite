package com.PanaMCAutomation.MC_BVT;
	...
	public class MC_UnScrapMaterial extends BaseTest {

		@Test(dataProvider = "getData")
		public void testB(Hashtable<String, String> data) throws Exception {
			test.log(Status.INFO, "To verify the functionlity of UnScrap Material. ");
			...
			System.out.println("Running UnScrap Material");
