package com.PanaMCAutomation.MC_BVT;
	...
	public class MC_ReceiveMaterialPrint extends BaseTest {

		@Test(dataProvider = "getData")
		public void testB(Hashtable<String, String> data) throws Exception {
			test.log(Status.INFO, "To verify the functionlity of Receive Material Print Option. ");
			...
			System.out.println("Running Receive Material Print");
