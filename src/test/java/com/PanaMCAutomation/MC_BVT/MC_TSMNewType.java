...
public class MC_TSMNewType extends BaseTest {
	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify functionlity of Creation of Time Sensetive Material Type");
		...
		System.out.println("Running TSM New Type");
