...
public class MC_AutoZero extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify the Auto Zero functionlity of Material. ");
		...
		System.out.println("Running AutoZero Test");
