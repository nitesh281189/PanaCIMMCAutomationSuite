package com.PanaMCAutomation.MC_BVT;
	...
	public class MC_VerifyRcCancelButon extends BaseTest {

		@Test(dataProvider = "getData")
		public void testB(Hashtable<String, String> data) throws Exception {
			test.log(Status.INFO, "To verify functionlity of Cancel button of Receive Material");
			...
			System.out.println("Running Cancel Receive Material");
