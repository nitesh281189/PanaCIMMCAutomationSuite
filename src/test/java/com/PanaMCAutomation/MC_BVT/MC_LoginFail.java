...
public class MC_LoginFail extends BaseTest {

	@Test(dataProvider = "getData")
	public void testB(Hashtable<String, String> data) throws Exception {
		test.log(Status.INFO, "To verify Login Failed functionlity of Application.");
		...
		System.out.println("Running Login Fail Test");
